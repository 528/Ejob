<div class="form_content">
    ...
    ?>
    <form id="valid_more_mcq_edit" method="post" action='<?= site_url($action) ?>' enctype ="multipart/form-data">
		...
		<tr>
			...
			<td>
				<?php $ans=sql::rows('more_mcq_answer',"questions_id=$questions_id order by answer_id");?>
