<div class="form_content" style="width:780px;">
    ...
    ?>
    <form id="valid_bcs_mcq" method="post" action='<?= site_url($action) ?>' enctype ="multipart/form-data">
        <table width="100%" border="0" cellspacing="3" cellpadding="2">
            <tr>
               ...
               <font color="red">   <?=form_error('tutorial_name', '<span>', '</span>')?>        </font>            </td>
                 ...
                 <tr>
            <th>Question ?<?php echo $question;?> <span class='required'><font color="red">*</font></span></th>
