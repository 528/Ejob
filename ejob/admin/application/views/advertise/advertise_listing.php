...
<!--        <button id="add" title="ipo_form/add_ipo_form"  class="jadd_button">ADD</button>
        ...
        <button id="add" title="advertise/activate_advertise" class="jedit_button">Activate</button>
         <button title="advertise/deactivate_advertise" class="jedit_button">DeActivate</button>
