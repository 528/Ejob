<div class="form_content">
    ...
    ?>
    <form id="valid_model_test" method="post" action='<?= site_url($action) ?>' enctype ="multipart/form-data">
            ...
            <tr>
              ...
              <tr>
                ...
                <span class='block margin_2_0'><font color="black"></font>
                    <input type='text' name='test_name' value='<?=set_value('test_name')?>' class='text required ui-widget-content ui-corner-all' />
            </span>
               <font color="red">   <?=form_error('test_name', '<span>', '</span>')?>        </font>            </td>
                </tr>
<!--                <tr><th>Or Add Question</th>
                   <td>
                <span>
                <select name="category" class="text required ui-widget-content ui-corner-all" onchange="javascript:showHint(this.value);">
