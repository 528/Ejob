...
<!--        <button id="add" title="ipo_form/add_ipo_form"  class="jadd_button">ADD</button>
        ...
        <button id="add" title="publisher/activate_publisher" class="jedit_button">Activate</button>
         <button title="publisher/deactivate_publisher" class="jedit_button">DeActivate</button>
